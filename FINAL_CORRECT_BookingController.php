...
class BookingController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        try {
            ...
            elseif ($user->role === 'head_division') {
                // ✅ FIX: Leader Divisi - lihat semua booking di divisinya (bukan hanya user_id)
     ...
     *
     * Endpoint: POST /bookings/{id}/approve-division
     * Role: head_division
     * Status: pending_division → pending_ga or rejected_division
     */
     ...
     *
     * Endpoint: POST /bookings/{id}/approve-divum
