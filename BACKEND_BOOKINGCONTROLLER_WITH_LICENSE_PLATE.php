...
class BookingController extends Controller
{
    ...
    /**
     * ✅ Get available rooms with all fields
     */
    ...
    /**
     * ✅ Get available vehicles with LICENSE PLATE (UPDATED!)
     */
    public function getAvailableVehicles(Request $request)
    {
        ...
        try {
            // ✅ INCLUDE license_plate field!
            $vehicles = Vehicle::where('is_active', true)
                              ->select('id', 'name', 'type', 'capacity', 'description', 'license_plate')
                              ->get();

            \Log::info('✅ [getAvailableVehicles] Retrieved ' . $vehicles->count() . ' vehicles');
