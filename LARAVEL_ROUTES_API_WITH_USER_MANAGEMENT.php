...
Route::middleware('auth:sanctum')->group(function () {
    ...
    // Apply middleware untuk pengecekan role admin
    ...
    Route::get('/bookings/{id}/available-slots', [BookingController::class, 'getAvailableSlots']);

    // Approval Routes (Leader & Admin)
    ...
    Route::get('/bookings/pending/approvals', [BookingController::class, 'getPendingApprovals']);
